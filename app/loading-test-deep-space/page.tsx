...
export default function DeepSpacePage() {
  return (
    <main className="relative w-full min-h-screen overflow-hidden" style={{ background: 'radial-gradient(ellipse at 50% 20%, #0d0d20 0%, #050510 25%, #020208 50%, #000000 75%, #000000 100%)' }}>
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 800px 600px at 20% 30%, rgba(65, 105, 225, 0.15) 0%, transparent 50%), radial-gradient(ellipse 600px 800px at 80% 70%, rgba(255, 105, 180, 0.1) 0%, transparent 50%)' }} />
