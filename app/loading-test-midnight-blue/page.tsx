...
export default function MidnightBluePage() {
  return (
    <main className="relative w-full min-h-screen overflow-hidden" style={{ background: 'radial-gradient(ellipse at 50% 20%, #0f1729 0%, #070b14 25%, #030508 50%, #010203 75%, #000000 100%)' }}>
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 800px 600px at 20% 30%, rgba(25, 25, 112, 0.15) 0%, transparent 50%), radial-gradient(ellipse 600px 800px at 80% 70%, rgba(255, 20, 147, 0.1) 0%, transparent 50%)' }} />
